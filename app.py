...
# Load model
model = load_model("/content/drive/MyDrive/herb_identifier.h5")

# Class names
class_names = sorted(os.listdir("/content/drive/MyDrive/dataset HPI"))

# Load CSV
df = pd.read_csv("/content/drive/MyDrive/herb_data.csv")
